...
#ifndef __S5K3P8SP03_LIB_H__
#define __S5K3P8SP03_LIB_H__

#include "sensor_lib.h"

#define SENSOR_MODEL "s5k3p8sp03"

/* s5k3p8sp03 Regs */
#define s5k3p8sp03_DIG_GAIN_GR_ADDR       0x020E /* 0x4000020E */
#define s5k3p8sp03_DIG_GAIN_R_ADDR        0x0210 /* 0x40000210 */
#define s5k3p8sp03_DIG_GAIN_B_ADDR        0x0212 /* 0x40000212 */
#define s5k3p8sp03_DIG_GAIN_GB_ADDR       0x0214 /* 0x40000214 */

#define s5k3p8sp03_DATA_PEDESTAL            0x40 /* 10bit */

#define s5k3p8sp03_MIN_DGAIN_REG_VAL        256 /* 1.0x */
#define s5k3p8sp03_MAX_DGAIN_REG_VAL        256 /* 1.0x */

/* s5k3p8sp03 FORMULAS */
#define s5k3p8sp03_MIN_DGAIN    (s5k3p8sp03_MIN_DGAIN_REG_VAL / 256)
#define s5k3p8sp03_MAX_DGAIN    (s5k3p8sp03_MAX_DGAIN_REG_VAL / 256)
...
{ \
  ...
  {0x0344, 0x0018, 0x00}, \
  {0x0348, 0x1217, 0x00}, \
  {0x034A, 0x0D97, 0x00}, /* Set resolution */ \
  {0x034C, 0x1200, 0x00}, /* Set resolution */ \
  {0x034E, 0x0D80, 0x00}, \
  {0x0408, 0x0000, 0x00}, \
  {0x0900, 0x0011, 0x00}, \
  {0x0380, 0x0001, 0x00}, \
...
{ \
  ...
  {0x0348, 0x1217, 0x00}, \
  {0x034A, 0x0D97, 0x00}, /* Set resolution */ \
  {0x034C, 0x0900, 0x00}, /* Set resolution */ \
  {0x034E, 0x06C0, 0x00}, \
  {0x0408, 0x0000, 0x00}, \
  {0x0900, 0x0112, 0x00}, \
  {0x0380, 0x0001, 0x00}, \
...
/* Sensor Handler */
static mz_samsung_sensor_lib_t sensor_lib_ptr =
{
  .sensor_slave_info =
  {
  ...
  {
    .white_level = 1023,
    .r_pedestal = s5k3p8sp03_DATA_PEDESTAL,
    .gr_pedestal = s5k3p8sp03_DATA_PEDESTAL,
    .gb_pedestal = s5k3p8sp03_DATA_PEDESTAL,
    .b_pedestal = s5k3p8sp03_DATA_PEDESTAL,
  },
  ...
  .out_info_array =
  {
    .out_info =
    {
      ...
      /* Res 1 */
      {
        .x_output = 2304,
        .y_output = 1728,
        .line_length_pclk = 10240,
        .frame_length_lines = 1822,
        .vt_pixel_clk = 560000000,
        .op_pixel_clk = 294800000,
        .binning_factor = 2,
        .binning_method = 1,
        .min_fps = 7.5,
        .max_fps = 30.0,
  ...
  .exposure_func_table =
  {
    .sensor_calculate_exposure = s5k3p8sp03_calculate_exposure,
