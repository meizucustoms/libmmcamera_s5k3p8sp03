...
============================================================================*/
#include "gt24c64a_imx362_s5k2l7_eeprom.h"

/** gt24c64a_imx362_s5k2l7_eeprom_get_calibration_items:
 ...
 * Return: void.
 **/
void gt24c64a_imx362_s5k2l7_eeprom_get_calibration_items(void *e_ctrl)
{
...
/** gt24c64a_imx362_s5k2l7_eeprom_get_module_info:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 *   Get Module detailes
 *
 ...
 * Return: void.
 **/
static void gt24c64a_imx362_s5k2l7_eeprom_get_module_info(sensor_eeprom_data_t *e_ctrl)
{
  unsigned char flag;
...
/** gt24c64a_imx362_s5k2l7_eeprom_format_wbdata:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 ...
 * Return: void.
 **/
static void gt24c64a_imx362_s5k2l7_eeprom_format_wbdata(sensor_eeprom_data_t *e_ctrl)
{
  unsigned char flag;
  module_info_t *module_info;
  awb_data_t    *wb;
...
/** gt24c64a_imx362_s5k2l7_eeprom_format_lensshading:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 ...
 * Return: void.
 **/
void gt24c64a_imx362_s5k2l7_eeprom_format_lensshading(sensor_eeprom_data_t *e_ctrl)
{
  unsigned char  flag;
...
/** gt24c64a_imx362_s5k2l7_eeprom_format_afdata:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 * Format the data structure of white balance calibration
 *
 ...
 * Return: void.
 **/
static void gt24c64a_imx362_s5k2l7_eeprom_format_afdata(sensor_eeprom_data_t *e_ctrl)
{
  unsigned char    flag;
  af_data_t        *af;
...
static void gt24c64a_imx362_s5k2l7_eeprom_format_pdafgain(sensor_eeprom_data_t *e_ctrl)
{
  ...
  flag = e_ctrl->eeprom_params.buffer[dcc_offset++];
  if (flag == VALID_FLAG) {
    ...
    for (i = 0; i < DCC_LENGTH; i++) {
      pdafc_2d->PD_conversion_coeff[i] = buffer[dcc_offset] << 8 | buffer[dcc_offset+1];
      dcc_offset += 2;
    }
  } else {
    SERR("PD: no valid dcc data in otp data");
    return;
  }
...
/** gt24c64a_imx362_s5k2l7_eeprom_format_calibration_data:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 ...
 * Return: void.
 **/
void gt24c64a_imx362_s5k2l7_eeprom_format_calibration_data(void *e_ctrl)
{
  ...
  gt24c64a_imx362_s5k2l7_eeprom_get_module_info(ctrl);
  gt24c64a_imx362_s5k2l7_eeprom_format_wbdata(ctrl);
  gt24c64a_imx362_s5k2l7_eeprom_format_lensshading(ctrl);
  gt24c64a_imx362_s5k2l7_eeprom_format_afdata(ctrl);
  gt24c64a_imx362_s5k2l7_eeprom_format_pdafgain(ctrl);
}

/** gt24c64a_imx362_s5k2l7_eeprom_eeprom_open_lib:
 *
 ...
 **/
void* gt24c64a_imx362_s5k2l7_eeprom_open_lib(void) {
  return &gt24c64a_imx362_s5k2l7_eeprom_lib_func_ptr;
}
