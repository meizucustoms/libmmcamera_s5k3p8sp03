...
============================================================================*/
#include "gt24c64a_s5k3p8sp08_eeprom.h"

/** gt24c64a_s5k3p8sp08_eeprom_get_calibration_items:
 ...
 * Return: void.
 **/
void gt24c64a_s5k3p8sp08_eeprom_get_calibration_items(void *e_ctrl)
{
...
/** gt24c64a_s5k3p8sp08_eeprom_get_module_info:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 *   Get Module detailes
 *
 ...
 * Return: void.
 **/
static void gt24c64a_s5k3p8sp08_eeprom_get_module_info(sensor_eeprom_data_t *e_ctrl)
{
  unsigned char flag;
...
/** gt24c64a_s5k3p8sp08_eeprom_format_wbdata:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 ...
 * Return: void.
 **/
static void gt24c64a_s5k3p8sp08_eeprom_format_wbdata(sensor_eeprom_data_t *e_ctrl)
{
  unsigned char flag;
  module_info_t *module_info;
  awb_data_t    *wb;
...
/** gt24c64a_s5k3p8sp08_eeprom_format_lensshading:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 ...
 * Return: void.
 **/
void gt24c64a_s5k3p8sp08_eeprom_format_lensshading(sensor_eeprom_data_t *e_ctrl)
{
  unsigned char  flag;
...
/** gt24c64a_s5k3p8sp08_eeprom_format_afdata:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 * Format the data structure of white balance calibration
 *
 ...
 * Return: void.
 **/
static void gt24c64a_s5k3p8sp08_eeprom_format_afdata(sensor_eeprom_data_t *e_ctrl)
{
  unsigned char    flag;
  af_data_t        *af;
...
static void gt24c64a_s5k3p8sp08_eeprom_format_pdafgain(sensor_eeprom_data_t *e_ctrl)
{
...
/** gt24c64a_s5k3p8sp08_eeprom_format_calibration_data:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 ...
 * Return: void.
 **/
void gt24c64a_s5k3p8sp08_eeprom_format_calibration_data(void *e_ctrl)
{
  ...
  gt24c64a_s5k3p8sp08_eeprom_get_module_info(ctrl);
  gt24c64a_s5k3p8sp08_eeprom_format_wbdata(ctrl);
  gt24c64a_s5k3p8sp08_eeprom_format_lensshading(ctrl);
  gt24c64a_s5k3p8sp08_eeprom_format_afdata(ctrl);
  gt24c64a_s5k3p8sp08_eeprom_format_pdafgain(ctrl);
}

/** gt24c64a_s5k3p8sp08_eeprom_eeprom_open_lib:
 *
 ...
 **/
void* gt24c64a_s5k3p8sp08_eeprom_open_lib(void) {
  return &gt24c64a_s5k3p8sp08_eeprom_lib_func_ptr;
}
